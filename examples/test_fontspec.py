...
font_spec = {"font.family": "sans-serif",      # use sans-serif as default font
             "font.serif": ["Linux Libertine Capitals O"],  # custom serif font
...
plt.text(0., .5, r"\LaTeX \, default sans-serif", family="sans-serif", ha="center")
plt.text(0., .3, r"Custom Serif Font", family="serif", ha="center")
plt.plot(x, x**2, "r--", label=r"Line 1, $f(x)=x^2$")
plt.plot(x, 1-x**2, "b", label=r"Line 2, $f(x)=1-x^2$")
plt.xlabel(r"Label with unicode (°/µm)")
